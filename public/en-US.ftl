...
letter-employee-supervisor =
    ...
    .body =
        ...
        To refresh your memory, as a blind team member, I use a screen reader to complete my workload. Just recently, I've found a solution to an accessibility challenge I've had throughout my use of { $solution ->
            [teamviewer] TeamViewer. I have encountered a number of accessibility pitfalls while providing support to our employees. For example, a recent update to the user interface has made the meeting ID and password impossible to read with my screen reader. What's more I haven't been able to hear the remote machine's audio reliably, and certain keyboard commands won't function properly. The difficulty becomes greater when providing support for a computer without a screen reader installed. 
            [quickassist] QuickAssist. I have encountered a number of accessibility pitfalls while providing remote support to our employees. I haven't been able to hear the remote machine's audio reliably, and certain keyboard commands won't function properly. The difficulty becomes greater when providing support for a computer without a screen reader installed. 
...
letter-employee-hr =
    ...
    .body =
        ...
        Until now, there's not been an accessibility answer to make remote technical support accessible to screen readers and magnifiers. Thus, I have had to work through various accessibility deficiencies found within { $solution ->
            [teamviewer] TeamViewer. I have encountered a number of accessibility pitfalls while providing support to our employees. A recent update to the user interface has made the meeting ID and password impossible to read with my screen reader. What's more I haven't been able to hear the remote machine's audio reliably, and certain keyboard commands won't function properly. The difficulty becomes greater when providing support for a computer without a screen reader installed. 
            [quickassist] QuickAssist. I have encountered a number of accessibility pitfalls while providing remote support to our employees. I haven't been able to hear the remote machine's audio reliably, and certain keyboard commands won't function properly. The difficulty becomes greater when providing support for a computer without a screen reader installed. 
            *[other] the current software. Providing remote support to our employees with our current platform introduces a number of accessibility pitfalls with my screen reader. I haven't been able to hear the remote machine's audio reliably, and certain keyboard commands won't function properly. The difficulty becomes greater when providing support for a computer without a screen reader installed. 
        }
...
letter-supervisor-hr =
    ...
    .body =
        ...
        Until now, there's not been an accessibility answer to make remote technical support accessible to screen readers and magnifiers. My team member has faced various issues throughout their use of { $solution ->
            [teamviewer] TeamViewer. My team member has informed me of the various accessibility pitfalls they have encountered throughout their work. A recent update to TeamViewer's user interface has made the meeting ID and password impossible to read with the screen reader issued to them. What's more they haven't been able to hear the remote machine's audio reliably, and certain keyboard commands won't function properly. The difficulty becomes greater when providing support for a computer without a screen reader installed. 
            [quickassist] QuickAssist. My team member has encountered a number of accessibility pitfalls while providing remote support to our employees. They haven't been able to hear the remote machine's audio reliably, and certain keyboard commands won't function properly. The difficulty becomes greater when providing support for a computer without a screen reader installed. 
            *[other] the current software, which introduces a number of accessibility pitfalls for my team member. They haven't been able to hear the remote machine's audio reliably, and certain keyboard commands won't function properly. The difficulty becomes greater when providing support for a computer without a screen reader installed. 
        }
